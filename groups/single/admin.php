<nav class="no-ajax section-navigation">
	<ul>
...
<?php if ( bp_is_group_admin_screen( 'edit-details' ) ) : ?>
	...
	<footer>
		<input type="submit" value="Spara ändringar" id="save" name="save" />
	</footer>
...
<?php if ( bp_is_group_admin_screen( 'group-avatar' ) ) : ?>
	...
	<?php if ( 'upload-image' == bp_get_avatar_admin_step() ) : ?>
			...
			<p>
				<a href="<?php echo bp_get_group_avatar_delete_link();?>" class="btn-dangerous small">Ta bort logotyp</a>
			</p>
			<?php endif; ?>
...
<?php if ( bp_is_group_admin_screen( 'manage-members' ) ) : ?>
	...
	<section>
		...
		<?php if ( bp_group_has_members( 'per_page=20&exclude_banned=false' ) ) : ?>
...
<?php if ( bp_is_group_admin_screen( 'membership-requests' ) ) : ?>
	...
	<?php else: ?>
		...
		<p class="no-content">Det finns inga nya ansökningar</p>
...
<?php if ( bp_is_group_admin_screen( 'delete-group' ) ) : ?>
	...
	<div class="message-warning">
		<p>Deleting this group will completely remove ALL content associated with it. There is no way back, please be careful with this option.</p>
	</div>
	...
	<p>
		<input type="submit" class="btn-dangerous" disabled="disabled" value="<?php _e( 'Delete Group', 'buddypress' ); ?>" id="delete-group-button" name="delete-group-button" />
	</p>
