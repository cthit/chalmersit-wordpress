...
a==="")});$(".autosize").autosize({append:"\n\n\n"});$.fn.tipsy.elementOptions=function(a,h){return $.extend({},h,{gravity:$(a).data("tooltip-gravity")||"s",offset:parseInt($(a).data("tooltip-offset"))||0})};"ontouchstart"in document&&$("#tools-menu-trigger").on("touchstart",function(){var a=$(this).next(".dropdown-sub");a.hasClass("open")?a.removeClass("open").slideUp(100):a.addClass("open").slideDown(200)});$('[rel="tooltip"]').tipsy({gravity:"s",offset:5});$("article .article-content img:not(.avatar)").each(function(){$(this).parent().is("figure")&&
$(this).parent().addClass("subtle-border")});$(".tabs").tabs({tabContainer:".tab-container > div",activeClass:"tab-current"});$("[role='search'] input").on("keyup",function(a){a.which==27&&this.blur()});$(".it_twitter").each(function(){var a=this,h=$(this).children("meta[name=twitter-content]").attr("content"),c=$(this).children("meta[name=twitter-type]").attr("content"),e=$(this).children("meta[name=twitter-count]").attr("content"),b="https://";if(c==="user")b+="api.twitter.com/1/statuses/user_timeline/";
b+=h+".json?callback=?";console.log(b);$.getJSON(b,function(d){var f=$("<ul />",{"class":"list"});d!=null?$.each(d,function(g){var i=new Date(this.created_at);i="<p>"+Chalmers.linkify(this.text)+"</p><time>"+i.toDateString()+"</time>";i=$("<li />",{html:i});f.append(i);return g<e-1}):f.html("<li>Kunde inte h\u00e4mta tweets fr\u00e5n Twitter</li>");$(a).find("#tweet-list").append(f)})})});